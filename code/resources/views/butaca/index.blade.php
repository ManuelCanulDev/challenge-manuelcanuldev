                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('butacas.destroy',$butaca->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('butacas.show',$butaca->id) }}"><i class="fa fa-fw fa-eye"></i> Ver</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('butacas.edit',$butaca->id) }}"><i class="fa fa-fw fa-edit"></i> Editar</a>
                                                    @csrf
                                                    @method('DELETE')
